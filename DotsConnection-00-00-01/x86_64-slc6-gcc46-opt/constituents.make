...
#cmt_local_tagfile = $(DotsConnection_tag).make
cmt_local_tagfile = $(bin)$(DotsConnection_tag).make
...
cmt_local_setup_DotsConnection = $(bin)setup_DotsConnection$$$$.make
...
DotsConnection_extratags = -tag_add=target_DotsConnection

#$(cmt_local_tagfile_DotsConnection) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DotsConnection) ::
else
$(cmt_local_tagfile_DotsConnection) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DotsConnection); then /bin/rm -f $(cmt_local_tagfile_DotsConnection); fi ; \
	  $(cmtexe) -tag=$(tags) $(DotsConnection_extratags) build tag_makefile >>$(cmt_local_tagfile_DotsConnection)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DotsConnection)"; \
	  test ! -f $(cmt_local_setup_DotsConnection) || \rm -f $(cmt_local_setup_DotsConnection); \
	  trap '\rm -f $(cmt_local_setup_DotsConnection)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DotsConnection_extratags) show setup >$(cmt_local_setup_DotsConnection) && \
	  if [ -f $(cmt_final_setup_DotsConnection) ] && \
	    \cmp -s $(cmt_final_setup_DotsConnection) $(cmt_local_setup_DotsConnection); then \
	    \rm $(cmt_local_setup_DotsConnection); else \
	    \mv -f $(cmt_local_setup_DotsConnection) $(cmt_final_setup_DotsConnection); fi
...
not_DotsConnection_dependencies = { n=0; for p in $?; do m=0; for d in $(DotsConnection_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DotsConnectiondirs :
	@if test ! -d $(bin)DotsConnection; then $(mkdir) -p $(bin)DotsConnection; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DotsConnection
else
DotsConnectiondirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DotsConnection
#
#$(cmt_local_DotsConnection_makefile) :: $(DotsConnection_dependencies) $(cmt_local_tagfile_DotsConnection) build_library_links dirs DotsConnectiondirs
#else
#$(cmt_local_DotsConnection_makefile) :: $(DotsConnection_dependencies) $(cmt_local_tagfile_DotsConnection) build_library_links dirs
#endif
#else
#$(cmt_local_DotsConnection_makefile) :: $(cmt_local_tagfile_DotsConnection)
#endif

ifdef cmt_DotsConnection_has_target_tag

ifndef QUICK
$(cmt_local_DotsConnection_makefile) : $(DotsConnection_dependencies) build_library_links
	$(echo) "(constituents.make) Building DotsConnection.make"; \
	  $(cmtexe) -tag=$(tags) $(DotsConnection_extratags) build constituent_config -out=$(cmt_local_DotsConnection_makefile) DotsConnection
else
$(cmt_local_DotsConnection_makefile) : $(DotsConnection_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DotsConnection) ] || \
	  [ ! -f $(cmt_final_setup_DotsConnection) ] || \
	  $(not_DotsConnection_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DotsConnection.make"; \
	  $(cmtexe) -tag=$(tags) $(DotsConnection_extratags) build constituent_config -out=$(cmt_local_DotsConnection_makefile) DotsConnection; \
	  fi
endif
...
$(cmt_local_DotsConnection_makefile) : $(DotsConnection_dependencies) build_library_links
	$(echo) "(constituents.make) Building DotsConnection.make"; \
	  $(cmtexe) -f=$(bin)DotsConnection.in -tag=$(tags) $(DotsConnection_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DotsConnection_makefile) DotsConnection
else
$(cmt_local_DotsConnection_makefile) : $(DotsConnection_dependencies) $(cmt_build_library_linksstamp) $(bin)DotsConnection.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DotsConnection) ] || \
	  [ ! -f $(cmt_final_setup_DotsConnection) ] || \
	  $(not_DotsConnection_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DotsConnection_extratags) build constituent_makefile -out=$(cmt_local_DotsConnection_makefile) DotsConnection

DotsConnection :: $(DotsConnection_dependencies) $(cmt_local_DotsConnection_makefile) dirs DotsConnectiondirs
	$(echo) "(constituents.make) Starting DotsConnection"
	@if test -f $(cmt_local_DotsConnection_makefile); then \
	  $(MAKE) -f $(cmt_local_DotsConnection_makefile) DotsConnection; \
	  fi
#	@$(MAKE) -f $(cmt_local_DotsConnection_makefile) DotsConnection
	$(echo) "(constituents.make) DotsConnection done"

clean :: DotsConnectionclean

DotsConnectionclean :: $(DotsConnectionclean_dependencies) ##$(cmt_local_DotsConnection_makefile)
	$(echo) "(constituents.make) Starting DotsConnectionclean"
	@-if test -f $(cmt_local_DotsConnection_makefile); then \
	  $(MAKE) -f $(cmt_local_DotsConnection_makefile) DotsConnectionclean; \
	fi
	$(echo) "(constituents.make) DotsConnectionclean done"
#	@-$(MAKE) -f $(cmt_local_DotsConnection_makefile) DotsConnectionclean

##	  /bin/rm -f $(cmt_local_DotsConnection_makefile) $(bin)DotsConnection_dependencies.make

install :: DotsConnectioninstall

DotsConnectioninstall :: $(DotsConnection_dependencies) $(cmt_local_DotsConnection_makefile)
	$(echo) "(constituents.make) Starting install DotsConnection"
	@-$(MAKE) -f $(cmt_local_DotsConnection_makefile) install
	$(echo) "(constituents.make) install DotsConnection done"

uninstall : DotsConnectionuninstall

$(foreach d,$(DotsConnection_dependencies),$(eval $(d)uninstall_dependencies += DotsConnectionuninstall))

DotsConnectionuninstall : $(DotsConnectionuninstall_dependencies) ##$(cmt_local_DotsConnection_makefile)
	$(echo) "(constituents.make) Starting uninstall DotsConnection"
	@if test -f $(cmt_local_DotsConnection_makefile); then \
	  $(MAKE) -f $(cmt_local_DotsConnection_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DotsConnection_makefile) uninstall
	$(echo) "(constituents.make) uninstall DotsConnection done"

remove_library_links :: DotsConnectionuninstall
...
#cmt_local_tagfile_config = $(DotsConnection_tag)_config.make
cmt_local_tagfile_config = $(bin)$(DotsConnection_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)DotsConnection_configsetup.make
...
#cmt_local_tagfile_config = $(DotsConnection_tag).make
cmt_local_tagfile_config = $(bin)$(DotsConnection_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)DotsConnectionsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(DotsConnection_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DotsConnection_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DotsConnection_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DotsConnection_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DotsConnection_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DotsConnectionsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DotsConnection_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DotsConnection_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DotsConnection_makesetup.make
...
#cmt_local_tagfile_make = $(DotsConnection_tag).make
cmt_local_tagfile_make = $(bin)$(DotsConnection_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DotsConnectionsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DotsConnection_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DotsConnection_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DotsConnection_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DotsConnection_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DotsConnection_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DotsConnectionsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DotsConnection_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DotsConnection_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DotsConnection_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DotsConnection_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DotsConnection_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DotsConnectionsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DotsConnection_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DotsConnection_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DotsConnection_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DotsConnection_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DotsConnection_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DotsConnectionsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DotsConnection_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DotsConnection_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DotsConnection_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DotsConnection_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DotsConnection_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DotsConnectionsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DotsConnection_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DotsConnection_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DotsConnection_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DotsConnection_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DotsConnection_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DotsConnectionsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DotsConnection_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DotsConnection_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DotsConnection_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DotsConnection_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DotsConnection_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DotsConnectionsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DotsConnection_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DotsConnection_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DotsConnection_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DotsConnection_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DotsConnection_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DotsConnectionsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
#cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(DotsConnection_tag)_OfflineEventLoopMgr_check_install_joboptions.make
cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(bin)$(DotsConnection_tag)_OfflineEventLoopMgr_check_install_joboptions.make
...
#cmt_final_setup_OfflineEventLoopMgr_check_install_joboptions = $(bin)DotsConnection_OfflineEventLoopMgr_check_install_joboptionssetup.make
...
#cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(DotsConnection_tag).make
cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(bin)$(DotsConnection_tag).make
cmt_final_setup_OfflineEventLoopMgr_check_install_joboptions = $(bin)setup.make
#cmt_final_setup_OfflineEventLoopMgr_check_install_joboptions = $(bin)DotsConnectionsetup.make
cmt_local_OfflineEventLoopMgr_check_install_joboptions_makefile = $(bin)OfflineEventLoopMgr_check_install_joboptions.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(DotsConnection_tag)_EventNavigator_check_install_runtime.make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(DotsConnection_tag)_EventNavigator_check_install_runtime.make
...
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)DotsConnection_EventNavigator_check_install_runtimesetup.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(DotsConnection_tag).make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(DotsConnection_tag).make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)setup.make
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)DotsConnectionsetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = $(bin)EventNavigator_check_install_runtime.make
